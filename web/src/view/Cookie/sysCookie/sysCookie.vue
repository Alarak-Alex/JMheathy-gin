  ...
  <div>
    ...
    <div class="gva-table-box">
            ...
            <template #default="scope">{{ formatDate(scope.row.CreatedAt) }}</template>
                    ...
                    <el-table-column label="用户Cookie" prop="userCookie" width="200">
                        <template #default="scope">
                             <div class="file-list">
                               <el-tag v-for="file in scope.row.userCookie" :key="file.uid" @click="downloadFile(file.url)">{{file.name}}</el-tag>
                             </div>
                        </template>
                    </el-table-column>
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button v-auth="btnAuth.edit" type="primary" link icon="edit" class="table-button" @click="updateCookieFunc(scope.row)">变更</el-button>
