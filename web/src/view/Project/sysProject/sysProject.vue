  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
           ...
           <el-form-item label="图片类型" prop="picType">
            <el-select v-model="searchInfo.picType" clearable placeholder="请选择" @clear="()=>{searchInfo.picType=undefined}">
        ...
        <el-form-item label="提示词ID" prop="promtId">
           ...
           <el-form-item label="cookie类型" prop="cookieType">
            <el-select v-model="searchInfo.cookieType" clearable placeholder="请选择" @clear="()=>{searchInfo.cookieType=undefined}">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button v-auth="btnAuth.edit" type="primary" link icon="edit" class="table-button" @click="updateSystemProjectFunc(scope.row)">变更</el-button>
